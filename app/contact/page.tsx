              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-gray-600">
                      ...
                      <p>Veterinary District, VT 12345</p>
                    </address>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">General: info@animalhospital.com</p>
                    <p className="text-gray-600">Appointments: dental@animalhospital.com</p>
                  </div>
                </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="h-96 bg-gray-200 rounded-lg flex items-center justify-center">
            ...
            <p className="ml-4 text-gray-500">Interactive map would be displayed here</p>
          </div>
        </div>
      </section>
    </div>
